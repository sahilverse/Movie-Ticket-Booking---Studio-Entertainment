...
const ComingSoon = () => {
    ...
    const [movies, setMovies] = React.useState<MovieCardType[]>([
        { _id: 1, name: "RRR", imageUrl: rrrImage, playTime: "2h 30m", releaseDate: "20 Sept 2024" },
        { _id: 2, name: "Joker", imageUrl: jokerImage, playTime: "2h 30m", releaseDate: "22 Sept 2024" },
        { _id: 3, name: "Kalki", imageUrl: kalkiImage, playTime: "2h 30m", releaseDate: "30 Sept 2024" },
    ]);
    return (
            ...
            <div className={styles.card_container}>
                {movies.map((movie) => (
                    <div key={movie._id} className={styles.card} onClick={() => router.push(`/coming-soon/${movie._id}`)}>
                        <Image src={movie.imageUrl} alt={movie.name} loading='lazy' className={styles.image} />
